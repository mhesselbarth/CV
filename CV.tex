...
\documentclass[10pt, hidelinks]{report}
...
% Simpkins, C.E., Hanß, S., Spangenberg, M.C., Salecker, J., \textbf{Hesselbarth, M.H.K.}, Wiegand, K. \textit{spectre: An R package to estimate spatially-explicit community composition using sparse data}. Ecography (in press).
